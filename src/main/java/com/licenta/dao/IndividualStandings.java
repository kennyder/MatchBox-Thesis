...
public class IndividualStandings {
    ...
    public IndividualStandings(int spot, String name, int points, int played, int wins, int defeats, int draws, int gf, int ga) {
        this.spot = spot;
        this.name = name;
        this.points = points;
        this.played = played;
